"""
Anchor phrase extractor. LLM returns a short verbatim phrase (5-15 words) per data
point; post-processing resolves it to the full containing sentence via fuzzy match.

Output is compatible with ground_results.py and generate_html.py.
"""
...
def extract_trial_data(client: OpenAI, text: str, pmid: str) -> dict:
    ...
    # Resolve anchors → full sentences before saving
